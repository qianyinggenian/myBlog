...
<span class="line"><span style="color:#24292E;">};</span></span></code></pre></div><h2 id="_3、camunda-json文件" tabindex="-1">3、camunda.json文件 <a class="header-anchor" href="#_3、camunda-json文件" aria-label="Permalink to &quot;3、camunda.json文件&quot;">​</a></h2><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{</span></span>
